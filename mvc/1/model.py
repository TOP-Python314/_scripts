...
class FileIO:
    _default_people_path = Path(path[0]) / 'people.json'
    
    @classmethod
    def read_all_people(cls, data_path: str | Path = None) -> list[Person]:
        if data_path is None:
            data_path = cls._default_people_path
...
if __name__ == '__main__':
    ...
    storage = FileIO.read_all_people()
